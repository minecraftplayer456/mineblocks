...
namespace Mineblocks {
    enum class LogCategory { Application, Common, Core };
    ...
    class Logger {
      public:
        ...
        void Log(spdlog::level::level_enum level, LogCategory category, const T& msg,
                 Args&&... args)
        {
            std::string format =
...
#define LOG_DEBUG_TRACE(Category, ...)                                                   \
    Mineblocks::Log::GetLogger().Trace(Mineblocks::LogCategory::Category, __VA_ARGS__)
#define LOG_DEBUG_DEBUG(Category, ...)                                                   \
    Mineblocks::Log::GetLogger().Debug(Mineblocks::LogCategory::Category, __VA_ARGS__)
#define LOG_DEBUG_INFO(Category, ...)                                                    \
    Mineblocks::Log::GetLogger().Info(Mineblocks::LogCategory::Category, __VA_ARGS__)
#define LOG_DEBUG_WARN(Category, ...)                                                    \
    Mineblocks::Log::GetLogger().Warn(Mineblocks::LogCategory::Category, __VA_ARGS__)
#define LOG_DEBUG_ERROR(Category, ...)                                                   \
    Mineblocks::Log::GetLogger().Error(Mineblocks::LogCategory::Category, __VA_ARGS__)
#define LOG_DEBUG_CRITICAL(Category, ...)                                                \
    Mineblocks::Log::GetLogger().Critical(Mineblocks::LogCategory::Category, __VA_ARGS__)
#else
#define LOG_DEBUG_TRACE(Category, ...)
#define LOG_DEBUG_DEBUG(Category, ...)
#define LOG_DEBUG_INFO(Category, ...)
