...
namespace mineblocks {
    Renderpass::Renderpass(const LogicalDevice* logicalDevice, const Surface* surface)
        : m_logicalDevice(logicalDevice)
    {
        ...
        Graphics::checkVk(vkCreateRenderPass(m_logicalDevice->getDevice(),
                                             &renderPassInfo, nullptr, &m_renderPass));
    }

    Renderpass::~Renderpass()
    {
        spdlog::debug("Destroy render pass");
